...
1. [Bearblog Backup]([https://github.com/rcapitao/bearblog-backup](https://github.com/rcapitao/bearblog-backup))
2. [Bearblog Crossposting]([https://github.com/rcapitao/bearblog-crossposting](https://github.com/rcapitao/bearblog-crossposting))

The first one does a daily backup of the posts from my blog hosted on [Bearblog]([https://bearblog.dev](https://bearblog.dev)), reading the Atom feed, saving everything in markdown, and downloading the images automatically. The second one handles crossposting, meaning that whenever I publish something new, it distributes the content to my social networks [Mastodon]([https://mastodon.social/@rcapitao](https://mastodon.social/@rcapitao)) and [Bluesky]([https://bsky.app/profile/rcapitao.com](https://bsky.app/profile/rcapitao.com)), reading my blog's RSS feed.  
...
I documented everything, from the execution to how to adapt it for other blogs on [Bearblog]([https://bearblog.dev](https://bearblog.dev)), in case anyone wants to take advantage of it.