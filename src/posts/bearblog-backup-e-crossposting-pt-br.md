...
O primeiro faz o backup diário dos posts do meu blog hospedado no [Bearblog]([https://bearblog.dev](https://bearblog.dev)), lendo o feed Atom, salvando tudo em markdown e baixando as imagens automaticamente. O segundo cuida do crossposting, ou seja, sempre que publico algo novo, ele distribui o conteúdo para as minhas redes sociais [Mastodon]([https://mastodon.social/@rcapitao](https://mastodon.social/@rcapitao)) e [Bluesky]([https://bsky.app/profile/rcapitao.com](https://bsky.app/profile/rcapitao.com)), lendo o feed RSS do meu blog.  
...
Documentei tudo, desde a execução até como adaptar para outros blogs no [Bearblog]([https://bearblog.dev](https://bearblog.dev)), caso alguém queira aproveitar.  
