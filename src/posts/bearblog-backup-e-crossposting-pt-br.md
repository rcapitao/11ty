...
Documentei tudo, desde a execução até como adaptar para outros blogs no [Bearblog](tab:[https://bearblog.dev](https://bearblog.dev)), caso alguém queira aproveitar.  
